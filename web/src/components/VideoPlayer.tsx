  ...
  useEffect(() => {
    if (!callAccepted) {
      ...
      if (myVideoStreamDivElement) {
        // hide myvideostreamdiv
        // myVideoStreamDivElement.style.display = 'none';
    ...
    <>
      {stream && (
        <div
          ...
          onMouseDown={callAccepted ? handleMouseDown : undefined}
          onTouchStart={callAccepted ? handleTouchStart : undefined}
          onMouseUp={callAccepted ? handleMouseUp : undefined}
          onTouchEnd={callAccepted ? handleMouseUp : undefined}
          onMouseMove={callAccepted ? handleMouseMove : undefined}
          onTouchMove={callAccepted ? handleTouchMove : undefined}
        >
          <h1
            className={
              callAccepted && !callEnded
